        ...
        <div className="flex flex-col justify-center bg-transparent gap-10 px-4 pb-10">
            ...
            <div className="flex flex-col gap-10">
                ...
                <div className="flex flex-col md:flex-row space-y-5 md:space-y-0 md:space-x-6 justify-center items-center relative">
                    <div className="absolute md:absolute md:left-0 md:transform md:-translate-x-1/4 left-0 cursor-pointer transform -translate-x-1/2 translate-y-1/3"  onClick={prevTestimonials}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 60 60" fill="none" className="transform rotate-180">
