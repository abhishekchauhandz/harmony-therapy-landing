...
export default function Hero() {
    ...
    return (
        <div className="flex justify-center md:flex md:py-20 md:mt-2 relative">
            <div className="flex flex-col md:flex-row items-center justify-between w-full mt-48 md:mt-32 md:px-12">


                {currentSlide === 0 && (
                    <div className="text-center md:text-left md:py-0 py-5 md:pl-0" data-aos="fade-left">
                ...
                {currentSlide === 0 && (
                    <div className="w-full md:w-[640px] w-full h-[400px] relative flex justify-center items-center" data-aos="fade-left">
                        <Image
                            src="/landingImages/banner1.png"
                            fill
                            objectFit="contain"
                ...
                {currentSlide === 1 && (
                    <div className="w-full md:w-[640px] w-[608px] h-[400px] relative flex justify-center items-center md:py-0 py-10" data-aos="fade-left">
                        <Image
                            src="/landingImages/banner2.png"
                            fill
                            objectFit="contain"
                            className="object-contain md:absolute md:bottom-0 absolute bottom-0"
                            alt="Hero Image"
                ...
                {currentSlide === 3 && (
                    <div className="text-center md:text-left md:py-0 py-5 md:pl-0" data-aos="fade-left">
                        <div className="w-full md:w-[469px]">
                            <span className="text-3xl md:text-5xl font-bold text-[#33C9D2]">Your pathway to inner peace
                            and 
                            </span>
                            <div>
            ...
            <div onClick={nextSlide} className="absolute md:absolute md:right-0 md:transform md:translate-x-1/2 right-0 top-1/2 transform translate-x-1/4 translate-y-1/2 cursor-pointer">
                <svg
            ...
            <div onClick={nextSlide} className="absolute md:absolute md:left-0 md:transform md:-translate-x-8 left-0 top-1/2 transform -translate-x-4 translate-y-1/2 cursor-pointer">
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="60"
                    height="60"
