...
const PrevArrow = ({ onClick }) => (
    <div onClick={onClick} className="absolute md:absolute md:left-0 md:transform md:-translate-x-10 left-0 top-1/2 transform -translate-x-8 -translate-y-1/2 cursor-pointer z-10">
        <svg
...
const NextArrow = ({ onClick }) => (
    <div onClick={onClick} className="absolute md:absolute md:right-0 md:transform md:translate-x-1/3 right-0 top-1/2 transform translate-x-1/4 -translate-y-1/2 cursor-pointer">
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width="60"
            height="60"
